...
var Miner = DS.Model.extend({
    ...
    "MHS av": DS.attr('string'),
    "MHS 5s": DS.attr('string'),
    "MHS 1m": DS.attr('string'),
    "MHS 5m": DS.attr('string'),
    "MHS 15m": DS.attr('string'),
    "Accepted": DS.attr('string'),
    "Rejected": DS.attr('string'),
    "Hardware Errors": DS.attr('string'),
    "Utility": DS.attr('string'),
    "Last Share Pool": DS.attr('string'),
    "Last Share Time": DS.attr('string'),
    "Total MH": DS.attr('string'),
